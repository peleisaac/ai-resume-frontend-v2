...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadSignUpForm(type) {
    ...
    const switchPath =
      type === "employer" ? "jobseekers-signup.html" : "employers-signup.html";
    const signInPath =
      type === "employer" ? "employers-signin.html" : "jobseekers-signin.html";
    ...
    document
      ...
      .addEventListener("click", function () {
        window.location.href =
          userRole === "employer"
            ? "employers-signin.html"
            : "jobseekers-signin.html";
      });
